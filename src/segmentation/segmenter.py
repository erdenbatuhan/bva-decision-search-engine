...
class Segmenter:
    ...
    def get_plain_texts_by_document(self, annotated=True):
        ...
        :param annotated: Whether or not the data returned is annotated
    ...
    def apply_segmentation(self, annotated=True, debug=False):
        ...
        :param annotated: Whether the data is annotated or not
        :param debug: Whether the error analysis is performed or not (default: False)
